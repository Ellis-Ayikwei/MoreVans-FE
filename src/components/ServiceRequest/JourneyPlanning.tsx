                                                                ...
                                                                <label className="flex items-center text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                                                                    <Field
                                                                        ...
                                                                        onChange={(e: any) => {
                                                                            ...
                                                                            if (e.target.checked) {
                                                                                const newLinkedItems = availableItems.map((item: any) => item.id);
                                                                                console.log('Setting new linked items:', newLinkedItems);
                                                                                setFieldValue(`journey_stops.${index}.linked_items`, newLinkedItems);
                                                                            } else {
                                                                                console.log('Clearing linked items');
                                                            ...
                                                            <div className="space-y-4">
                                                                {values.journey_stops
                                                                    ...
                                                                    .map((pickupStop: any, pickupIdx: number) => {
                                                                        ...
                                                                        console.log('Rendering pickup stop:', pickupStop.location, 'with items:', availableItemsFromPickup);
                                                                                ...
                                                                                <div className="flex items-center justify-between mb-3">
                                                                                    ...
                                                                                    <label className="flex items-center text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                                                                                        <Field
                                                                                            ...
                                                                                            onChange={(e: any) => {
                                                                                                console.log('Pickup checkbox changed:', e.target.checked);
                                                                                                const currentLinkedItems = stop.linked_items || [];
                                                                                                console.log('Current linked items:', currentLinkedItems);
                                                                                                if (e.target.checked) {
