                    ...
                    <motion.div className="lg:w-1/2 w-full px-4 lg:px-8" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto lg:mx-0">
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                                    ...
                                    <div className="flex items-center mb-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
                                        <IconTruck className="text-blue-300 mr-2" />
                                        <span className="text-sm text-gray-300">Full house relocations</span>
                                    </div>
                                    <motion.div
                                        className="h-1 bg-secondary rounded-full opacity-80"
                                        initial={{ width: '0%' }}
                            ...
                            >
                                ...
                                />
                                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                                    <h3 className="font-bold text-xl group-hover:text-secondary transition-colors duration-300">Specialty Items</h3>
                                    <div className="flex items-center mb-2 opacity-0 group-hover:opacity-100 transition-opacity translate-y-4 group-hover:translate-y-0 duration-300">
                                        <IconTruck className="text-secondary mr-2" />
                                        <span className="text-sm text-secondary-300">Pianos, art & antiques</span>
                                    </div>
                                    <motion.div
                                        className="h-1 bg-secondary rounded-full opacity-80"
                                        initial={{ width: '0%' }}
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ delay: 1.2, duration: 0.6 }}
                            className="bg-white/10 backdrop-blur-md p-4 sm:p-6 rounded-2xl shadow-xl border border-white/10 mt-6 sm:mt-8 transform max-w-2xl mx-auto lg:mx-0"
                        >
                            ...
                            >
                                <div className="text-center">
                                    <div className="flex justify-center text-amber-500 text-lg">
                                        ...
                                        <IconStar className="w-4 h-4 text-yellow-500" />
                                        <IconStar className="w-4 h-4 text-yellow-500" />
                                        <IconStarHalf className="w-4 h-4 text-yellow-500" />
                                    </div>
