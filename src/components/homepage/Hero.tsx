    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="relative z-10 mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
                ...
                <div className="grid max-w-9/10 lg:grid-cols-2 gap-16 text-center lg:text-left">
                    {/* Content Column */}
                    <motion.div className="space-y-8" initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: 'easeOut' }}>
                        <div>
                            <h1 className="text-5xl lg:text-6xl xl:text-8xl font-bold text-white leading-tight">
                                Moving Made
                            ...
                            {serviceCards.map((card, index) => (
                                ...
                                >
                                    <div className={`relative overflow-hidden ${
                                        ...
                                        {/* Hover overlay with "Get Price Now" - using secondary color for all cards */}
                                        <div className="absolute inset-0 bg-secondary/90 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                                    ...
                                    <div className="p-4">
                                        <h3 className="font-bold text-gray-900 mb-1 group-hover:text-secondary transition-colors">{card.title}</h3>
